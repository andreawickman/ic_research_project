...
# Plot trace plots
traceplot(fit_sample, pars = c('intercept', 'sigma_f', 'lengthscale_f', 'sigma_g', 'lengthscale_g'))

# Plot pairs plot for diagnostics
pairs(fit_sample, pars = c('intercept', 'sigma_f', 'lengthscale_f', 'sigma_g', 'lengthscale_g'))
```
